...
* Regenerated the translation template (`.pot`) so it matches the current source strings, and added the missing Swedish translations (`sv_SE`) — including the Support tab text "If you still need help, please open a support ticket with Krokedil.", which previously fell back to English.
