				...
				<div class="krokedil_settings__sidebar_section">
					<div class="krokedil_settings__sidebar_content">
						<?php if ( ! empty( $plugin_resources ) ) : ?>
							<h1 class="krokedil_settings__sidebar_title"><?php echo esc_html( __( 'Plugin resources', 'klarna-payments-for-woocommerce' ) ); ?></h1>
						...
						<?php if ( ! empty( $additional_resources ) ) : ?>
							<h1 class="krokedil_settings__sidebar_title"><?php echo esc_html( __( 'Additional resources', 'klarna-payments-for-woocommerce' ) ); ?></h1>
